...
def main(end_time: datetime, ffmpeg_path: str, pool_directory: str, pool_report_path: str, pool_size: int, screenshot_count: int, screenshot_directory: str, start_time: datetime, video_path: str):
